...
def build_charmm(job, write_files=True):
    ...
    forcefield_files = '../../TIP4P-2005.xml'
    molecule_A = mb.load('../../TIP4.mol2')
    molecule_A.name = 'TIP4'
    ...
    #openmm does not like TIP4P here because of mass-less particle
