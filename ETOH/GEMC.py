...
gomc_steps_production = 25000000 # set value for paper = 60 * 10**6
...
gomc_equilb_output_name_str="C2OH_equil"
...
gomc_production_output_name_str="C2OH_prod"
...
def build_charmm(job, write_files=True):
    ...
    box_0_temp_to_length_ang_dict = {275: 46,
                                     300: 46,
                                     325: 47,
                                     350: 47,
                                     375: 48,
    ...
    box_1_temp_to_length_ang_dict = {275: 370,
                                     300: 210,
                                     325: 160,
                                     350: 90,
                                     375: 84,
    ...
    box_0_temp_to_molecules_dict = {275: 980,
                                     300: 980,
                                     325: 970,
                                     350: 970,
                                     375: 970,
    ...
    box_1_temp_to_molecules_dict = {275: 20,
                                     300: 20,
                                     325: 30,
                                     350: 30,
                                     375: 30,
    ...
    forcefield = '../../trappe-ua.xml'
    #forcefield_C3A = '../../trappe-ua.xml'
    molecule_A = mb.load('../../C2OH-UA.mol2')
    molecule_B = mb.load('../../C1OH-UA.mol2')
    molecule_A.name = 'C2OH'
    molecule_B.name = 'C1OH'
    

    #forcefield_files = {molecule_A.name : forcefield_C3A , molecule_B.name : forcefield_C2A}
    forcefield_files = {molecule_A.name : forcefield }

    #molecule_type_list = [molecule_A,molecule_B]
    molecule_type_list = [molecule_A]
    mol_fraction_molecule_A = 1.0
    mol_fraction_molecule_B = 0.0
...
#    molecule_mol_fraction_list = [mol_fraction_molecule_A,mol_fraction_molecule_B]
    fixed_bonds_list = [molecule_A.name]
...
#            int(Liquid_box_Total_molecules * water_mol_ratio)
    ...
    box_0_molecules = [int(box_0_temp_to_molecules_dict[job.sp.production_temperature_K])]

#    box_0_molecules = [int(box_0_temp_to_molecules_dict[job.sp.production_temperature_K]*mol_fraction_molecule_A),
#           int(box_0_temp_to_molecules_dict[job.sp.production_temperature_K]*mol_fraction_molecule_B)] 

    box_1_molecules = [int(box_1_temp_to_molecules_dict[job.sp.production_temperature_K])]
   # box_1_molecules = [int(box_1_temp_to_molecules_dict[job.sp.production_temperature_K]*mol_fraction_molecule_A),
    #       int(box_1_temp_to_molecules_dict[job.sp.production_temperature_K]*mol_fraction_molecule_B)]
   ...
   # box_1_molecules = box_1_temp_to_molecules_dict[job.sp.production_temperature_K]
    ...
    box_liq = mb.fill_box(compound=molecule_type_list,
                          n_compounds=box_0_molecules,overlap=0.22,
...
def build_psf_pdb_ff_gomc_conf(job):
    ...
    box_1_temp_to_rcutcoulomb_dict = {275:100,
                                     300: 50,
                                     325: 30,
                                     350: 20,
                                     375: 20,
    ...
    MEMC_2Freq = 0.0
    MEMC_3Freq = 0.0
    #memc_move_1 = [1, "R134", ["C11","C21"], "ETH", ["C1", "C2"]]
    #memc_move_1 = [1, "NDO", ["C1", "CC"], "NDE", ["C1", "CA"]]
    #memc_all_moves = [memc_move_1]


   # memc_move_1 = [1, "R134", ["C11","C12"], "ETH", ["C1", "C2"]]
   # MEMC_input = [memc_move_1]
        ...
        if len(starting_temps_K_for_critical_point_list) >= use_last_no_temps_for_critical_calcs:
            ...
            if use_last_no_temps_for_critical_calcs > len(starting_temps_K_for_critical_point_list):
                ...
                if lowest_Tr_K_for_Tc_iter >= lowest_Tr_for_critical_calcs:
                    print('Ttemperatures used for critical point calcs = ' + str(temp_for_critical_list))
