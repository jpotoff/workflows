...
gomc_steps_nvt_equilibration = 1000000 # steps for NVT pre-equilibration step
...
coordinate_output_nvt_freq = 500000 # # set value for paper = 50 * 10**3
...
def build_charmm(job, write_files=True):
    ...
    box_0_temp_to_length_ang_dict = {300: 25,
                                     350: 25,
                                     400: 25,
                                     450: 25,
                                     500: 25,
    ...
    box_1_temp_to_length_ang_dict = {300: 100,
                                     350: 100,
                                     400: 100,
                                     450: 100,
                                     500: 100,
    ...
    box_1_temp_to_molecules_dict = {300: 1000,
                                     350: 1000,
                                     400: 1000,
                                     450: 1000,
                                     500: 1000,
    ...
    box_0_length_ang = 25
    box_1_length_ang = 100
    box_0_molecules = job.sp.initial_molecules
    box_1_molecules = 1000
...
def build_psf_pdb_ff_gomc_conf(job):
    ...
    RcutCoulomb_box_0=12.0 * u.angstrom
...
def part_5a_analysis_individual_simulation_averages(job):
    # copy all of the histogram data to another directory for processing.
    source_dir = "."
