...
gomc_equilb_output_name_str="EXP6_equil"
...
gomc_production_output_name_str="EXP6_prod"
...
def build_charmm(job, write_files=True):
    ...
    box_1_temp_to_length_ang_dict = {300: 335,
                                     350: 154,
                                     400: 90,
                                     450: 58,
                                     500: 50,
    ...
    forcefield_files = '../../EXP6_water.xml'
    molecule_A = mb.load('../../EXP6.mol2')
    molecule_A.name = 'WAT'
