...
def build_charmm(job, write_files=True):
    ...
    forcefield_files = '../../OPC3.xml'
    molecule_A = mb.load('../../OPC3.mol2')
    molecule_A.name = 'WAT'
