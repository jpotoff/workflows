...
gomc_steps_nvt_equilibration = 10000000 # steps for NVT pre-equilibration step
gomc_steps_equilibration = 100000000 #  set value for paper = 60 * 10**6
gomc_steps_production    = 100000000 # set value for pauper = 60 * 10**6
