...
gomc_nvt_equilb_output_name_str="C1A_nvt"
...
gomc_equilb_output_name_str="C1A_equil"
...
gomc_production_output_name_str="C1A_prod"
...
def build_charmm(job, write_files=True):
    ...
    box_0_temp_to_length_ang_dict = {480: 55,
     				     165: 48,
     				     160: 48,
     				     150: 48,
     				     145: 48,
