...
gomc_ff_filename_str = "TIP3P-ML_FF"
...
def build_charmm(job, write_files=True):
    ...
    forcefield_files = '../../TIP3P-ML.xml'
    molecule_A = mb.load('../../TIP3P-ML.mol2')
    molecule_A.name = 'WAT'
